...
\dates{November 2023 - }\\
Data Engineer with a proven track record in optimizing data pipelines and improving operational efficiency for fleet tracking system. Experienced in leveraging technologies such as Python, SQL, Docker, DBT, Databricks, and PySpark. Skilled in data modeling, ETL processes, and CI/CD practices, from development to deployment using cloud technologies such as Azure Blob Storage, Azure Functions, AWS Lambda, AWS S3, AWS EC2, AWS Glue.
